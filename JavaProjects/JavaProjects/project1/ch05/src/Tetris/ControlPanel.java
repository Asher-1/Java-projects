...
class ControlPanel extends JPanel {
	...
	private JButton
	        btCplay = new JButton("电脑游戏"),
	        btHplay = new JButton("人工游戏"),
	        btPause = new JButton("暂停游戏"),
	        btResume= new JButton("恢复游戏"),
	        btStop = new JButton("结束游戏");
	...
	public ControlPanel(final ErsBlocksGame game) {
		...
		plTip.add(new JLabel("下一方块"), BorderLayout.NORTH);
		plTip.add(plTipBlock);
		plTip.setBorder(border);
		
		//plInfo.add(new JLabel("难度"));
		//plInfo.add(tfLevel);
		//plInfo.add(new JLabel("消除行数"));
		//plInfo.add(tfScore);
		
		plInfo.add(new JLabel("  4行"));
		plInfo.add(tfScore4);
		plInfo.add(new JLabel("  3行"));
		plInfo.add(tfScore3);
		plInfo.add(new JLabel("  2行"));
		plInfo.add(tfScore2);
		plInfo.add(new JLabel("  1行"));
		plInfo.add(tfScore1);
